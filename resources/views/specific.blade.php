...
<div class="text-center px-6">
    <div class="p-1">
        <div class="my-1"><a href="/"><button type="button" class="items-center px-5 py-2 border border-transparent text-base font-medium rounded-full shadow-sm text-white focus:outline-none focus:ring-2 focus:ring-offset-2 bg-gray-600 hover:bg-gray-700 focus:ring-gray-500 w-96">Back to Main</button></a></div>
    </div>
</div>
</body>
</html>
